...
“*Executable*” *paper* means, that all the code in this paper was executed to produce this paper and can be executed as well. To read how to expand the code and play with it, please got to the [Appendix](./appendix.ipynb) Notebook. To expand the Notebooks just click the button below and you will be directed to Binder:<br><br>
